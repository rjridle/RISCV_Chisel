####################################################################
# Innovus Foundation Flow Code Generator, Tue Jul 21 17:27:54 CDT 2020
...
if {$vars(restore_design)} { restoreDesign DBS/place.enc.dat riscv }
...
if {[file exists RPT/cts.summary]} {
   exec /bin/mail -s "FF: riscv, cts completed ([pwd])" < RPT/cts.summary ryanridley46@gmail.com
} elseif {[file exists RPT/cts.summary.gz]} {
   exec gunzip -c RPT/cts.summary.gz | /bin/mail \
      -s "FF: riscv, cts completed ([pwd])" ryanridley46@gmail.com
} else {
   exec /bin/mail -s "FF: riscv, cts completed ([pwd])" < /dev/null ryanridley46@gmail.com
}
