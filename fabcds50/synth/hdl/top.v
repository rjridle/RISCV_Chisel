...
module datapath( // @[:@622.2]
  ...
  wire  rf_clk; // @[riscvSingle.scala 525:20:@627.4]
...
module riscv( // @[:@1085.2]
  ...
  wire  dp_clk; // @[riscvSingle.scala 58:20:@1090.4]
...
module top( // @[:@1147.2]
  ...
  wire  r_clk; // @[riscvSingle.scala 1082:19:@1152.4]
